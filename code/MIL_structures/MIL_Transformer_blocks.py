"""
Transformer blocks   Script  ver： Nov 26th 14:00

Altered output to get all feature sequence for MIL_structures-SI structure
based on：timm
...
class VisionTransformer(nn.Module):  # From timm to review the ViT
    ...
    def forward_features(self, x):
        ...
        # print(x.shape,self.pos_embed.shape) B,num_patches, D
    ...
    def forward(self, x):
        ...
        # B, 1+num_patches, D
        # fixme Altered output to get all feature sequence for MIL_structures-SI structure
